...
\bibitem{vonNeumann} John von Neumann, ``First Draft of a Report on the EDVAC'', 
1945.
\bibitem{caaqa} John L. Hennessy \& David A. Patterson, ``Computer 
Architecture,'' \emph{A Quantitative Approach,} Morgan Kaufmann, Fifth Edition, 
2012.
\bibitem{coadthsi} David A. Patterson \& John L. Hennessy, ``Computer 
