...
\chapter{Architecture}
   ...
   \section{BKM Fixed}
      ...
      \begin{tabular}{cl}
         \hline
         Código de operación  &  Operación   &  Descripci\'on                                                  \\ \hline \hline
         000000               &  $\exp(z1)$  &  Descripci\'on                                                  \\ \hline
         000000               &  $\ln(z1)$   &  Descripci\'on                                                  \\ \hline
         000000               &  $\cos(z1)$  &  Descripci\'on doble                                            \\ \hline
         000000               &  $\sin(z1)$  &  Descripci\'on doble                                            \\ \hline
         000000               &  $\atan(z1)$ &  Descripci\'on doble                                            \\ \hline
         000000               &  $\tan(z1)$  &  Descripci\'on doble                                            \\ \hline
         000000               &  $\cosh(z1)$ &  Descripci\'on doble                                            \\ \hline
         000000               &  $\sinh(z1)$ &  Descripci\'on doble                                            \\ \hline
         000000               &  $\atanh(z1)$&  Descripci\'on doble                                            \\ \hline
      \end{tabular}
