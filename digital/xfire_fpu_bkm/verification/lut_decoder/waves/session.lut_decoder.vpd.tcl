...
#<Session mode="Full" path="/home/ilesser/repos/xfire/digital/xfire_fpu_bkm/verification/lut_decoder/waves/session.lut_decoder.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 20} {1799 1011}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 522} {child_wave_right 1272} {child_wave_colname 193} {child_wave_colvalue 325} {child_wave_col1 0} {child_wave_col2 1}}
...
if { ![gui_is_db_opened -db {waves/lut_decoder.vpd}] } {
	gui_open_db -design V1 -file waves/lut_decoder.vpd -nosource
}
...
gui_open_source -id ${Source.1}  -replace -active bkm_fixed temp/bkm_fixed.v
gui_view_scroll -id ${Source.1} -vertical -set 1134
